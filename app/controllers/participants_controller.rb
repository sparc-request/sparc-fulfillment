class ParticipantsController < ApplicationController
  ...
  def participant_params
    params.require(:participant).permit(:last_name, :first_name, :middle_initial, :mrn, :external_id, :status, :date_of_birth, :gender, :ethnicity, :race, :address, :phone, :recruitment_source)
  end
