...
$("table.procedures tbody tr[data-id='<%= @procedure.id %>']").attr('data-billing-type', "<%= @procedure.billing_type %>")
$("table.procedures tbody tr[data-id='<%= @procedure.id %>']").attr('data-group-id', "<%= @procedure.group_id %>")
