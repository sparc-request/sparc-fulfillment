module ParticipantHelper
  ...
  def participant_report_formatter(participant)
    content_tag(:a, class: 'btn btn-default btn-xs participant_report', href: '#', title: 'Participant Report', 'data-participant_id' => participant.id, 'data-title' => 'participant_report') do
